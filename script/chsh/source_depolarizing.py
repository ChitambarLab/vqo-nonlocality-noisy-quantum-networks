...
The considered noise model is depolarizing channel applied
...
def source_depolarizing_nodes_fn():
...
if __name__ == "__main__":
    ...
    data_dir = "data/chsh/source_depolarizing/"
    ...
    # min prep ansatz and general measurement
    time_start = time.time()
