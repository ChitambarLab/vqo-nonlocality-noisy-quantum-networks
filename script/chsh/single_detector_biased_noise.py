...
"""
This script considers the CHSH scenario with biased noise detectors errors applied
to the first detector detector.
...
if __name__ == "__main__":
    ...
    for i, gamma in enumerate(scan_range):
        params_range[:, i] = [gamma, 0]

    data_filepath = "data/chsh/single_detector_biased_noise/"
    client = Client(processes=True, n_workers=5, threads_per_worker=1)

    """
    # min optimal ryrz_cnot
    """
